...
**Note:** This lab copies a lot of data around and can take a long time to complete.  It can also get a bit frustrating when it fails midway through the pipeline with a sometimes cryptic message.  Let me know and I can help.  There is a completed JSON template that you can also use to deploy the resources that *should* work if you get stuck.  
...
7. Execute the [full solution script](Solution/Create Staging NYCTaxiData.sql)
